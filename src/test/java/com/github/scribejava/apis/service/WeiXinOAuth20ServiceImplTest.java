...
class WeiXinOAuth20ServiceImplTest {

    @Test
    void shouldCreateInstanceWithValidConfig() {
        OAuthConfig config = new OAuthConfig("key", "secret");
        WeiXinOAuth20ServiceImpl service = new WeiXinOAuth20ServiceImpl(WeiXinApi20.instance(), config);
    ...
    void shouldExtractOpenIdAndAddToRequest() {
        OAuthConfig config = new OAuthConfig("key", "secret");
        WeiXinOAuth20ServiceImpl service = new WeiXinOAuth20ServiceImpl(WeiXinApi20.instance(), config);
        String rawResponse = "{\"openid\": \"wx_openid_456\"}";
        ...
        assertTrue(completeUrl.contains("openid=wx_openid_456"),
                "Expected openid=wx_openid_456 in URL but got: " + completeUrl);
    }
