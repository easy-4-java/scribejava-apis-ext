...
/**
 * OAuth 2.0 service implementation for QQ (Tencent).
 * <p>
 ...
 * @since 3.0.0
 * @see com.github.scribejava.apis.QQApi20
 * @see OAuth20Service
 */
public class QQOAuth20ServiceImpl extends OAuth20Service {

    /** Regex pattern to extract the {@code openid} value from the QQ access token response JSON. */
    private static Pattern openIdPattern = Pattern.compile("\"openid\":\\s*\"(\\S*?)\"");

    /**
     * Constructs a new QQ OAuth 2.0 service.
     *
     * @param api    the {@link DefaultApi20} API descriptor for QQ
